package com.example.demo.security.validata.common.impl;
...
import com.example.demo.security.validata.common.ValidateCode;
import com.example.demo.security.validata.common.ValidateCodeGenerator;
import com.example.demo.security.validata.common.ValidateCodeProcessor;
...
public abstract class AbstractValidateCodeProcessor<C extends ValidateCode> implements ValidateCodeProcessor {
    ...
    private C generate(ServletWebRequest request) {
        ...
        if (validateCodeGenerator == null) {
            throw new BaseException("验证码生成器" + generatorName + "不存在");
        }
